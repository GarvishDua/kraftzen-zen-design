...
const floatingIcons = [
  { Icon: Leaf, className: "absolute top-32 right-[15%] text-primary/20", size: 40, anim: { y: [-10, 10, -10], rotate: [0, 15, 0] }, dur: 7 },
  { Icon: Leaf, className: "absolute bottom-32 left-[10%] text-primary/15", size: 28, anim: { y: [10, -15, 10], rotate: [0, -10, 0] }, dur: 9 },
  { Icon: Sparkles, className: "absolute top-[25%] right-[8%] text-sand/60", size: 24, anim: { y: [-8, 12, -8], scale: [1, 1.2, 1] }, dur: 5 },
  { Icon: Zap, className: "absolute top-[70%] left-[5%] text-primary/15", size: 22, anim: { y: [5, -10, 5], rotate: [-5, 10, -5] }, dur: 8 },
  { Icon: Star, className: "absolute top-[15%] left-[20%] text-sand/40", size: 18, anim: { y: [-5, 8, -5], scale: [1, 1.3, 1] }, dur: 6 },
  { Icon: Leaf, className: "absolute top-[60%] right-[5%] text-sand/80", size: 32, anim: { y: [5, -20, 5], rotate: [10, -5, 10] }, dur: 6 },
  { Icon: Sparkles, className: "absolute bottom-[20%] right-[25%] text-primary/10", size: 20, anim: { y: [0, -12, 0], rotate: [0, 20, 0] }, dur: 10 },
];
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Additional orbs */}
        <div className="absolute top-10 right-[30%] w-52 h-52 bg-green-400/8 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "1s" }} />
        <div className="absolute bottom-[30%] left-[20%] w-64 h-64 bg-blue-400/6 rounded-full blur-3xl animate-pulse-glow" style={{ animationDelay: "3s" }} />
        <div className="absolute top-[40%] right-[10%] w-40 h-40 bg-sand/30 rounded-full blur-2xl animate-pulse-glow" style={{ animationDelay: "4s" }} />
        ...
        <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial from-primary/8 to-transparent rounded-full" />
      </div>
